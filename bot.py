...
class Bot_app(ttk.Frame):
    ...
    def create_widget_root(self):
        ...
        self.frame1 = ttk.Frame(self.containerFrame, width=110, height=150)
        self.frame1.pack(side="left", padx=20, pady=20)
        self.btnInstaOpen = ttk.Button(
            self.frame1, text="Like&Comment", command=self.window_comment_like)
        ...
        self.img1 = Image.open("material/comment.png")
        self.resized_image1 = self.img1.resize(
            (85, 85), Image.Resampling.LANCZOS)
        ...
        self.btnLinkOpen = ttk.Button(
            self.frame3, text="Feed", command=self.window_feed)
        ...
        self.img3 = Image.open("material/feed.png")
        self.resized_image3 = self.img3.resize(
            (70, 85), Image.Resampling.LANCZOS)
        ...
        self.frame2.pack(side="right", padx=40, pady=20)
        self.btnLinkOpen = ttk.Button(
            self.frame2, text="Stories", command=self.window_stories)
        self.btnLinkOpen.pack(side="bottom", padx=20, pady=10)
        self.canvas2 = Canvas(self.frame2, width=90, height=90)
        self.canvas2.pack(pady=5)
        self.img2 = Image.open("material/stories.png")
        self.resized_image2 = self.img2.resize(
            (85, 85), Image.Resampling.LANCZOS)
...
# Bot windows
    ...
    def window_comment_like(self):
        ...
        self.w1.iconbitmap('material/ico/comment.ico')
        ...
        self.entryHashtag.place(x=115, y=30)
        self.labelSpinbox = ttk.Label(
            self.w1, text="Number of pics for each # (1, 3 or 5):")
        self.labelSpinbox.place(x=30, y=70)
        self.spinbox = ttk.Spinbox(
            self.w1, from_=1, to=5, increment=2, state='readonly')
        self.spinbox.place(x=30, y=100, width=70)
        self.btnLaunch = ttk.Button(
            self.w1, text="Launch bot", command=self.thread_bot_full)
        self.btnLaunch.place(x=30, y=150)
        self.btnStop = ttk.Button(
            self.w1, text="Stop bot", command=self.stop_thread_bot_full)
        self.btnStop.place(x=120, y=150)
    ...
    def window_stories(self):
        ...
        self.w2.iconbitmap('material/ico/stories.ico')
        self.w2.geometry("300x180")
        self.w2.resizable(0, 0)
        self.label_spinbox = ttk.Label(
            self.w2, text="Number of stories (15 to 30):")
        ...
        self.btn_launch = ttk.Button(
            self.w2, text="Launch bot", command=self.thread_bot_stories)
        self.btn_launch.place(x=30, y=120)
        self.btn_stop = ttk.Button(
            self.w2, text="Stop bot", command=self.stop_thread_bot_stories)
        self.btn_stop.place(x=120, y=120)
    ...
    def window_feed(self):
        ...
        self.w3.iconbitmap('material/ico/feed.ico')
        self.w3.geometry("300x180")
        self.w3.resizable(0, 0)
        self.label_spinbox = ttk.Label(
            self.w3, text="Number of articles (5 to 10):")
        self.label_spinbox.place(x=30, y=30)
        self.spinbox = ttk.Spinbox(self.w3, from_=5, to=10, state='readonly')
        self.spinbox.place(x=30, y=60, width=70)
        self.btn_launch = ttk.Button(
            self.w3, text="Launch bot", command=self.thread_bot_feed)
        self.btn_launch.place(x=30, y=120)
        self.btn_stop = ttk.Button(
            self.w3, text="Stop bot", command=self.stop_thread_bot_feed)
        self.btn_stop.place(x=120, y=120)
    ...
    def bot_stories(self):
        ...
        if self.stop_bot_stories == False:
            ...
            button_cookies = driver.find_element(
                By.CSS_SELECTOR, 'body > div.RnEpo.Yx5HN._4Yzd2 > div > div > button.aOOlW.HoLwm')
            ...
            try:
                button_cookies = driver.find_element(
                    By.XPATH, '/html/body/div[4]/div/div/button[1]').click()
                sleep(3)
            except:
                pass

            # Remember username
            remember_user_button = driver.find_element(
                By.XPATH, '//*[@id="react-root"]/section/main/div/div/div/div/button').click()
            sleep(5)

            # notifications
            button_notifications = driver.find_element(
                By.XPATH, '/html/body/div[1]/div/div[1]/div/div[2]/div/div/div[1]/div/div[2]/div/div/div/div/div/div/div/div[3]/button[2]')
            button_notifications.click()
            sleep(3)

            # Select stories
            first_history = driver.find_element(
                By.XPATH, '/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/div[1]/section/main/div[1]/section/div[1]/div[2]/div/div/div/div/ul/li[4]/div/button')
            first_history.click()
            sleep(3)
            ...
            for n in range(int(n_stories)):  # Like on history
                try:
                    try:
                        # Like buttons:
                        like_button1 = driver.find_element(
                            By.XPATH, '/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/div[1]/section/div[1]/div/div[5]/section/div/div[3]/div/div/div[2]/span/button')
                        like_button1.click()
                        sleep(1)
                    except:
                        like_button2 = driver.find_element(
                            By.XPATH, '/html/body/div[1]/div/div[1]/div/div[1]/div/div/div[1]/div[1]/section/div[1]/div/div[5]/section/div/div[3]/div/div/div/span/button')
                        like_button2.click()
                        sleep(1)
                    ...
                    if n < int(n_stories) - 1:
                        ...
                        button_next = driver.find_element(
                            By.XPATH, '/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/div[1]/section/div[1]/div/div[5]/section/div/button[2]')
        ...
        if self.stop_bot_full == False:
            ...
            for h in hashtag:
                driver.get('https://www.instagram.com/explore/tags/' +
                           str(hashtag[contador]))
                sleep(7)

                # Select first thumbnail
                first_post = driver.find_element(
                    By.XPATH, '/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/div[1]/section/main/article/div[1]/div/div/div[1]/div['+ str(n_post) +']/a/div').click()
                sleep(5)
                ...
                for n in range(int(n_hashtag)):  # Like and Comment on post
                    ...
                    button_like = driver.find_element(
                        By.XPATH, '/html/body/div[1]/div/div/div/div[2]/div/div/div[1]/div/div[3]/div/div/div/div/div[2]/div/article/div/div[2]/div/div/div[2]/section[1]/span[1]/button').click()
                    sleep(3)
                    ...
                    print('Post ' + str(n + 1) +
                          ' en #' + str(hashtag[contador]))

                    close_thumbnail = driver.find_element(
                        By.XPATH, '/html/body/div[1]/div/div/div/div[2]/div/div/div[1]/div/div[2]/div/div')
                    ...
                    if n < int(n_hashtag) - 1:
                        print('Next post')
                        n_post += 1
                        next_post = driver.find_element(
                            By.XPATH, '/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/div[1]/section/main/article/div[1]/div/div/div[1]/div['+ str(n_post) +']/a/div')
                        next_post.click()
                        sleep(3)
    ...
    def bot_feed(self):
        ...
        if self.stop_bot_feed == False:
            ...
            n_post = self.spinbox.get()

            n_article = 1

            print('Number of posts: ' + str(int(n_post)))
            ...
            for n in range(int(n_post)):  # Like and Comment on post

                # Select article
                next_article = driver.find_element(
                    By.XPATH, '/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/div[1]/section/main/div[1]/section/div[1]/div[3]/div[1]/div/article[' + str(n_article) + ']/div/div[3]/div/div/section[1]')
                actions = ActionChains(driver)
                actions.move_to_element(next_article).perform()
                sleep(2)

                # Like
                button_like = driver.find_element(By.XPATH, '/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/div[1]/section/main/div[1]/section/div[1]/div[3]/div[1]/div/article[' + str(
                    n_article) + ']/div/div[3]/div/div/section[1]/span[1]/button').click()
                sleep(2)

                # Post Comment
                try:
                    # Select textarea
                    textarea = driver.find_element(By.XPATH, '/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/div[1]/section/main/div[1]/section/div[1]/div[3]/div[1]/div/article[' + str(
                        n_article) + ']/div/div[3]/div/div/section[3]/div/form/textarea')
                    actions = ActionChains(driver)
                    actions.move_to_element(textarea).perform()
                    sleep(3)

                    post_comment = driver.find_element(By.XPATH, '/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/div[1]/section/main/div[1]/section/div[1]/div[3]/div[1]/div/article[' + str(
                        n_article) + ']/div/div[3]/div/div/section[3]/div/form/textarea')
                    post_comment.click()
                except:
                    pass
                ...
                print('Article ' + str(n_article) + ' complete')
